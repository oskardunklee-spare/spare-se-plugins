...
- [ ] First word of the customer-facing comment is `Spare` or `Spare's` (or `Within Spare [Product]` where Spare is still the first named subject). Flag any other opener. Acceptable: `Spare supports...`, `Spare's Live Map...`, `Within Spare EAM, warranty alerts...`. Not acceptable: `In an AV deployment...`, `Barcode scanning...`, `The Spare Maintain app...`.
